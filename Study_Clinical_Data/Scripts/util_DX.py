...
if __name__ == '__main__':
    ...
    if os.path.exists('./Studies/{}/intermediate/{}_mri_clinical_combined.csv'.format(study, study)):
        ...
        ### step 1 and step 2: clean the clincial data and combine them
        ...
        df_combined.to_csv('./Studies/{}/intermediate/{}_{}_mri_clinical_combined.csv'.format(study, study,Diagnosis), index = False)
        df_clin.to_csv('./Studies/{}/intermediate/{}_{}_cleaned_clinical.csv'.format(study,study,Diagnosis), index = False)

        with open('./Studies/{}/intermediate/{}_{}.pkl'.format(study,study,Diagnosis), 'wb') as f:
            pickle.dump(flag, f)
